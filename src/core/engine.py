...
from src.scenes.setting_scene import SettingScene   # ← 要加這一行
...
class Engine:
    ...
    def __init__(self):
        ...
        scene_manager.register_scene("catch_pokemon", CatchPokemonScene())
        ...
        '''
        scene_manager.register_scene("setting", SettingScene())  # ← 正確的位置
